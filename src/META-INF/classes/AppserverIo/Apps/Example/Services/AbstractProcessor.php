...
abstract class AbstractProcessor
{
    ...
    public function postConstruct()
    {
        $this->getInitialContext()->getSystemLogger()->info(
            sprintf('%s::postConstruct() has successfully been invoked by @PostConstruct annotation', get_class($this))
        );
    }
    ...
    {
        $this->getInitialContext()->getSystemLogger()->info(
            sprintf('%s::preDestroy() has successfully been invoked by @PreDestroy annotation', get_class($this))
        );
    }
    ...
    {
        $this->getInitialContext()->getSystemLogger()->info(
            sprintf('%s::postDetach() has successfully been invoked by @PostDetach annotation', get_class($this))
        );
    }
    ...
    {
        $this->getInitialContext()->getSystemLogger()->info(
            sprintf('%s::preAttach() has successfully been invoked by @PreAttach annotation', get_class($this))
        );
    }
