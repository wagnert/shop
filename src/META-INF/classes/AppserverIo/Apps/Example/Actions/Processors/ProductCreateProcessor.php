...
/**
 * AppserverIo\Apps\Example\Actions\Processors\ProductCreateProcessor
 *
 * NOTICE OF LICENSE
 *
...
class ProductCreateProcessor extends AbstractCreateProcessor
{
    ...
    protected function getStatements()
    {
        ...
        return array(
            $utilityClassName::PRODUCT_CREATE => $this->getUtilityClass()->find($utilityClassName::PRODUCT_CREATE)
        );
    }
