...
/**
 * AppserverIo\Apps\Example\Actions\Processors\ProductDeleteProcessor
 *
 * NOTICE OF LICENSE
 *
...
class ProductDeleteProcessor extends AbstractDeleteProcessor
{
    ...
    protected function getStatements()
    {
        ...
        return array(
            $utilityClassName::PRODUCT_DELETE => $this->getUtilityClass()->find($utilityClassName::PRODUCT_DELETE)
        );
    }
}
