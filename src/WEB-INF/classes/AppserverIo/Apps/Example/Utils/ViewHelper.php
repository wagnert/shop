...
class ViewHelper
{
    ...
    /**
     * Returns the actual HTML page title.
     *
     * @param \AppserverIo\Psr\Servlet\Http\HttpServletRequestInterface $servletRequest The request instance
     *
     * @return string The HTML page title for the actual request
     */
    public function getPageTitle(HttpServletRequestInterface $servletRequest)
    {
        // @TODO Return the page title here
    }
