 ...
 *
 * @Results({
 *     @Result(name="input", result="/dhtml/customer-account.dhtml", type="AppserverIo\Routlt\Results\ServletDispatcherResult"),
 *     @Result(name="failure", result="/dhtml/customer-account.dhtml", type="AppserverIo\Routlt\Results\ServletDispatcherResult")
 * })
 */
